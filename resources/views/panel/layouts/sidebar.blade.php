        ...
        <ul class="list-unstyled menu-categories mt-n1" id="accordionExample">
            ...
            <li class="menu">
                <a href="#submenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="submenu" data-parent="#accordionExample">
                    ...
                    <li>
                        <a class="ml-n4" href="javascript:void(0);"> Asignacion de Tareas </a>
                    </li>
                    <li>
                        <a class="ml-n4" href="javascript:void(0);">Enviar Respuesta de Tareas </a>
                    </li>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu1" data-parent="#accordionExample">
                    ...
                    <li>
                        <a class="ml-n4" href="javascript:void(0);"> Grupo de tares </a>
                    </li>
                    <li>
                        <a class="ml-n4" href="javascript:void(0);"> Proyectos </a>
                    </li>
                    {{-- <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu2" data-parent="#accordionExample">
                    <li>
                        <a href="javascript:void(0);"> Todos los activos </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"> Intalaciones </a>
                    </li>
                    <li>
