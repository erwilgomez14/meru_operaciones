            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" required autofocus class="form-control" placeholder="Nombre de usuario">
                        ...
                        <p class="terms-conditions text-center"><span style="color: #1e638c">HidroBolivar </span>© 2023 Todos los derechos Reservados. </p>
